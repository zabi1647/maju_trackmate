...
class AcceptPcReservationApi {
  Future<bool> acceptPcsReservatins(String id, String user, String slot) async {
    ...
    try {
      ...
      var request =
          http.MultipartRequest('POST', Uri.parse(acceptPcsReservationApi));
